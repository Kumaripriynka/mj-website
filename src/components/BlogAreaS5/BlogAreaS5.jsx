            ...
            <div className="row justify-content-between align-items-center">
               ...
               <div className="col-md-auto">
                  <div className="sec-btn mt-n3 mt-md-0">
                     <Link onClick={ClickHandler} to="/blog" className="th-btn2 style3 th-icon">VIEW ALL</Link>
                  </div>
               </div>
            </div>
               ...
               {BlogData.slice(4, 6).map((Blog, index) => (
                  <div className="col-lg-6" key={index}>
                     <div className="blog-card style2">
                        ...
                        <Link onClick={ClickHandler} to={`/blog-details/${Blog.slug}`} className="th-btn2 style3">EXPLORE MORE</Link>
                     </div>
                  </div>
               ))}
