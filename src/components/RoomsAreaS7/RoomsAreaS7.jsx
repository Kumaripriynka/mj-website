      ...
      <section className="overflow-hidden space-bottom">
         <div className="container">
            <div className="title-area text-center">
               <span className="sub-title2 style1">RELATED ROOMS</span>
               <h2 className="sec-title">Related rooms & suits</h2>
            </div>
            <div className="row gy-4">

               {RoomData.slice(0, 3).map((item, iroom) => (
