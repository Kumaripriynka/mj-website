  ...
  return (
    <div className={props.hclass || ''}>
      <div className="container">
        <form className="booking-form style2" onSubmit={handleSubmit}>
        ...
        <div className="booking-arraw"><i className="fa-light fa-angle-down"></i></div>
      </div>
    </div>
  );
};

export default BookingAreaS4;
